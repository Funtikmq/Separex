...
const handleResize = useCallback((e, resizingIndex, startX, startY, startDimensions) => {
...
}, [selectedCategory, doorDimensions, selectedType, setSectionDimensions, updateDimensions]);
